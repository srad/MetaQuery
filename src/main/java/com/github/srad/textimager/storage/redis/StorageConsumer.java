...
import com.github.srad.textimager.storage.AbstractConsumer;
...
public class StorageConsumer extends AbstractConsumer {
    ...
    public void run() {
        try {
            ...
            RedisSetAsyncCommands<String, String> cmdSet = connection.async();
                ...
                try {
                    ...
                    switch (element.getClass().getSimpleName()) {
                        ...
                        case "SortedSetCommand":
                            ...
                            break;
                        case "SetAddCommand":
                            futures.add(connection.async().sadd(element.key, (String)element.data));
                            break;
